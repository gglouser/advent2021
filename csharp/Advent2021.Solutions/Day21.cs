                                ...
                                if (turn % 2 == 0)
                                {
                                    ...
                                    for (int die1 = 1; die1 <= 3; die1++)
                                        for (int die2 = 1; die2 <= 3; die2++)
                                            ...
                                            {
                                                var newPos = (pos1 + die1 + die2 + die3) % 10;
                                                var newScore = score1 + newPos + 1;
                                                if (newScore < WinningScore)
                                                    newState[newPos, pos2, newScore, score2] += count;
                                                else
                                                    totalPlayer1Wins += count;
                                            }
                                }
                                else
                                {
                                    ...
                                    for (int die1 = 1; die1 <= 3; die1++)
                                        for (int die2 = 1; die2 <= 3; die2++)
                                            for (int die3 = 1; die3 <= 3; die3++)
                                            {
                                                var newPos = (pos2 + die1 + die2 + die3) % 10;
                                                var newScore = score2 + newPos + 1;
                                                if (newScore < WinningScore)
                                                    newState[pos1, newPos, score1, newScore] += count;
                                                else
                                                    totalPlayer2Wins += count;
                                            }
                                }
